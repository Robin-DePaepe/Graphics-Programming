...
Camera::Camera(const FPoint3& pos)
...
const FMatrix4& Camera::UpdateAndGetOnb(float x, float y)
{
	if (m_CameraChanged)
	{
		UpdateOnbMatrix(x, y);
...
void Camera::UpdateOnbMatrix(float x, float y)
{
	...
	m_Onb = { FVector4{rightV,0}, FVector4{upV,0}, FVector4{m_ForwardV,0}, FVector4{FVector3{m_Position},1} };
